...
class TestBaseVAECanonicalNames:
    ...
    def test_timevae_has_reconstruction_weight(self) -> None:
        ...
        model = TimeVAE(sequence_length=100, input_dim=1, latent_dim=10, reconstruction_weight=2.5)
    ...
    def test_no_seq_len_attribute(self) -> None:
        ...
        model = TimeVAE(sequence_length=100, input_dim=1, latent_dim=10)
...
class TestFullModelInstantiation:
    ...
    def test_full_instantiation(self) -> None:
        """TimeVAE(sequence_length=100, input_dim=1, latent_dim=10) works."""
        model = TimeVAE(sequence_length=100, input_dim=1, latent_dim=10)
