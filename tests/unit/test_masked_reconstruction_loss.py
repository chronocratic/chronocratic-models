...
"""Unit tests for masked_reconstruction_loss."""

import torch

from chronocratic.models.utils import masked_reconstruction_loss
...
def test_masked_loss_ignores_padding() -> None:
    ...
    loss = masked_reconstruction_loss(per_element, keep_mask)
