"""Tests for Series2Vec fine-tuning via SupervisedModule.
...
from tscollection.models._supervised import make_series2vec_finetuner
from tscollection.models.convolutional.standard.series2vec.model import Series2Vec


class TestSeries2VecFinetuningModule:
    """Verify Series2Vec fine-tuning via SupervisedModule works correctly."""
