...
class RepresentationBackbone(Protocol):
    ...
    Implementations:
        - :class:`~tscollection.models.transformer.tst.model.TST`
        - :class:`~tscollection.models.convolutional.standard.series2vec.model.Series2Vec`
        - :class:`~tscollection.models.convolutional.standard.tstcc.model.TSTCC`
    """
