...
from chronocratic.models.supervised.supervised import FlattenLinearHead, SupervisedModule
...
def make_tst_supervised(
    ...
    *,
    ...
    head = FlattenLinearHead(
        in_features=backbone.representation_dim * backbone.sequence_length, num_outputs=num_outputs
    )
