...
class RecurrentAutoEncoder(LightningModule, BasicEncodingMixin):
    ...
    def __init__(
        ...
        loss: RecurrentEncoderLoss = RecurrentEncoderLoss.MSE,
        ...
        rnn_cls = getattr(nn, recurrent_cell_type.value)
        ...
        self.loss_fn: nn.Module = nn.MSELoss() if loss == RecurrentEncoderLoss.MSE else nn.L1Loss()
