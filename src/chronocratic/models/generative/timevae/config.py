...
class TimeVAEModelParameters:
    ...
    Args:
        ...
        reconstruction_wt: Weight applied to the reconstruction term
        ...
        custom_seas: Optional list of ``(num_seasons, len_per_season)``
    ...
    hidden_layer_sizes: list[int] = field(default_factory=lambda: [50, 100, 200])
    trend_poly: int = 0
